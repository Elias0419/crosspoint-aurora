...
class GfxRenderer {
 ...
 public:
  ...
  int getSpaceAdvance(int fontId, uint32_t leftCp, uint32_t rightCp, EpdFontFamily::Style leftStyle,
                      EpdFontFamily::Style rightStyle) const;
  /// Returns the kerning adjustment between two adjacent codepoints.
  int getKerning(int fontId, uint32_t leftCp, uint32_t rightCp, EpdFontFamily::Style leftStyle,
                 EpdFontFamily::Style rightStyle) const;
